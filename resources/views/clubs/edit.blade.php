         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" value="{{ $club->address }}" class="form-control" placeholder="address">
...
<div class="form-group">
    ...
    <input type="text" name="head_of_club" value="{{ $club->head_of_club }}" class="form-control" placeholder="head_of_club">
